...
class Math(commands.Cog):
    ...
    async def math(ctx, first: discord.Option(float, description="The first number"), second: discord.Option(float, description="The second number"), operation: discord.Option(description="What operation you want to run", choices=["+", "-", "*", "/"])):
        if operation == '+':
            oper = first + second
        if operation == '-':
            oper = first - second
